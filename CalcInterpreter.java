...
//que nome terrivel para um ficheiro
public class CalcInterpreter extends CalcBaseVisitor<Value> {
	//não
   //há um que spamma st
   //penso que não porque não encontrei
   //o eduardo tem
   // a pasta -> do professor -> do eduardo gg em que estás tem ficheiros stg certo?
   //então tem de ter ficheiros que usam o stg
   //nao, estou a falar da pasta do prfoessor
   //não tenho a pasta :|
   // tenta não morrer
