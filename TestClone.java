...
class Forms {
    ...
    static class HoleQuestion extends Question {
        ...
        public Fraction execute(Scanner scanner) {
            clone = new HoleQuestion(super.getResult(), this.question, this.solution, this.getQuestionId());
    ...
    static class OpenQuestion extends Question {
        ...
        @Override
        public Fraction execute(Scanner scanner) {
            clone = new OpenQuestion(super.getResult(), this.question, this.getQuestionId());
            return clone.run(scanner);
        }
